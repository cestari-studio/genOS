    ...
    <div style={{ padding: '2rem' }}>
      <Section level={1}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
          ...
          <AILabel size="mini"><AILabelContent><p style={{ fontSize: '0.75rem' }}>{t('Responses are generated by the selected AI model. Accuracy varies; always verify critical information.')}</p></AILabelContent></AILabel>
        </div>
